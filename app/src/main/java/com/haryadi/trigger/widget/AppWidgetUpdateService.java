    ...
    protected void onHandleIntent(Intent intent) {
        ...
        for (int widgetId : widgetIds) {
            ...
            if (trigger_id == -1) {
                ...
                views.setTextViewText(R.id.widget_empty_text, getString(R.string.widget_empty_text));
            } else {
                ...
                if (cursor == null) {
                    views.setViewVisibility(R.id.widget_empty_text, View.VISIBLE);
                    views.setTextViewText(R.id.widget_empty_text, getString(R.string.widget_empty_norecord));
                }
